...
The Second Condition is an interaction using a physical mug. A controller/tracker is fixed to a real mug which lines up with a 
virtual mug model. The user is meant to use their bare hands to pick up the physical mug and place it on the target. 
